...
const app = express();
const corsOptions = {
  origin: "https://smartexamhub-git-main-zoren-panilagaos-projects.vercel.app",
...
app.options("https://smartexamhub-git-main-zoren-panilagaos-projects.vercel.app", (req, res) => {
  console.log('Request received:', req.method, req.url);
  res.header("Access-Control-Allow-Origin", "https://smartexamhub-git-main-zoren-panilagaos-projects.vercel.app");
  ...
  try {
    ...
    const sendPasswordResetEmail = async (username, resetToken) => {
      ...
      const mailOptions = {
        ...
        text: `Click the following link to reset your password: https://smartexamhub-git-main-zoren-panilagaos-projects.vercel.app/reset-password/${resetToken}`,
      };
